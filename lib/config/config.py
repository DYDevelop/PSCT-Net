...
# projection lpips loss'weight
__C.CTGAN.map_projection_lpips_lambda = 0.
# lpips 3d loss weight
__C.CTGAN.lpips_3d_lambda = 0.
__C.CTGAN.demo_lambda = 0.
# 'l1' or 'mse'
